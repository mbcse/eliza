...
- คุณยังสามารถโหลดตัวละครด้วย `npm start --characters="path/to/your/character.json"` และเรียกใช้บอทหลายตัวพร้อมกันได้
...
```bash
npm test           # รันการทดสอบหนึ่งครั้ง
npm test:watch    # รันการทดสอบในโหมดติดตาม
```

สำหรับการทดสอบฐานข้อมูลเฉพาะ:

```bash
npm test:sqlite   # รันการทดสอบด้วย SQLite
npm test:sqljs    # รันการทดสอบด้วย SQL.js
```
