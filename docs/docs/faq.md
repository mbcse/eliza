...
1.  **Install Python, Node.js and npm**: Ensure you have the necessary software prerequisites installed on your system. We use node v23.
...
3.  **Install Eliza**: Use the command `npm install @ai16z/eliza` or `npm add @ai16z/eliza` to install the Eliza package.
