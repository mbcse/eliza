...
```bash
# PostgreSQL
npm add @ai16z/adapter-postgres pg

# SQLite
npm add @ai16z/adapter-sqlite better-sqlite3

# SQL.js
npm add @ai16z/adapter-sqljs sql.js

# Supabase
npm add @ai16z/adapter-supabase @supabase/supabase-js
```
