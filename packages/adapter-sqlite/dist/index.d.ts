...
import { Plugin, DatabaseAdapter, IDatabaseCacheAdapter, UUID, Participant, Account, Actor, Memory, GoalStatus, Goal, Relationship, RAGKnowledgeItem } from '@elizaos/core';
...
export { SqliteDatabaseAdapter, sqlitePlugin as default, load, loadVecExtensions, sqliteTables };
