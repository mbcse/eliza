...
- npm install updates npm lockfile when it should not [\#1121](https://github.com/ai16z/eliza/issues/1121)
...
- This command: npm start --characters="characters/tate.character.json" results in an error [\#817](https://github.com/ai16z/eliza/issues/817)
- Characters Do Not Actually Use ExamplePost or ExampleMessage [\#791](https://github.com/ai16z/eliza/issues/791)
- `npm run dev` does not work out of the box [\#780](https://github.com/ai16z/eliza/issues/780)
...
- Error: Property 'clients' does not exist on type 'Plugin' in src/index.ts during npm start [\#423](https://github.com/ai16z/eliza/issues/423)
...
- npm install fails on Ubuntu [\#215](https://github.com/ai16z/eliza/issues/215)
...
- chore: fix broken npm lockfile [\#1115](https://github.com/ai16z/eliza/pull/1115) ([shakkernerd](https://github.com/shakkernerd))
...
- chore: fix broken npm lockfile [\#1103](https://github.com/ai16z/eliza/pull/1103) ([shakkernerd](https://github.com/shakkernerd))
...
- chore: kill npm start [\#1093](https://github.com/ai16z/eliza/pull/1093) ([shakkernerd](https://github.com/shakkernerd))
...
- chore: fix broken npm lockfile [\#1081](https://github.com/ai16z/eliza/pull/1081) ([shakkernerd](https://github.com/shakkernerd))
...
- fix: Fix npm lockfiles [\#1055](https://github.com/ai16z/eliza/pull/1055) ([jzvikart](https://github.com/jzvikart))
...
- Error npm start - Promise.withResolvers\(\): pdfjs-dist [\#902](https://github.com/ai16z/eliza/issues/902)
...
- `npm  start` crashes if there is too much data in knowledge [\#866](https://github.com/ai16z/eliza/issues/866)
...
- npm install error - ELIFECYCLE Exit code 1 [\#720](https://github.com/ai16z/eliza/issues/720)
...
- fix: npm-lock.yaml [\#664](https://github.com/ai16z/eliza/pull/664) ([monilpat](https://github.com/monilpat))
...
- Severe Bug - The program fails to start with the command 'npm start', urgent fix required [\#326](https://github.com/ai16z/eliza/issues/326)
- npm start reports an error and cannot be started. Why is this? I installed it according to the documentation steps. [\#288](https://github.com/ai16z/eliza/issues/288)
